...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/datatables/1.10.20/css/dataTables.foundation.min.css" integrity="sha256-/6ecmXPZDHXBtIkRX3OBVMTmR39Yr/chJQPFKFX16EY=" crossorigin="anonymous" />
    @stack('css')
    </head>
    <body class="{{ $class ?? '' }}">
        @auth()
